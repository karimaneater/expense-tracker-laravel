        ...
        <div class="modal-content">
            ...
            <form action="" id="expensesForm">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        <select name="expense_category_id"  id="expense_category_id" class="expense_category_id form-control">
                    ...
                    <div class="form-floating mb-3">
                        <input type="number" class="form-control amount" min="1" value="" name="amount" id="amount" placeholder="Amount">
                        <label for="amount">Amount</label>
                    </div>

                    <div class="form-floating mb-3">
                        <input type="date" class="form-control entry_date" value="" name="entry_date" id="entry_date" placeholder="Entry Date">
                        <label for="entry_date">Entry Date</label>
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary btn-sm" data-bs-dismiss="modal">Close</button>
                    <button type="button" id="expensesSubmitBtn" class="btn btn-primary btn-sm">Save changes</button>
                </div>
            </form>
        </div>
    </div>
