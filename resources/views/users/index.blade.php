                ...
                @foreach($users as $user)
                    <tr>
                        ...
                        <td>
                            ...
                            {!! Form::submit('Delete', ['class' => 'btn btn-danger btn-sm', 'data-bs-toggle' => 'modal', 'data-bs-target' => '#confirm-delete']) !!}
                            {!! Form::close() !!}
                        </td>
                    </tr>
                <!-- Modal -->
                <div class="modal fade" id="confirm-delete" tabindex="-1" aria-labelledby="modal-label" aria-hidden="true">
